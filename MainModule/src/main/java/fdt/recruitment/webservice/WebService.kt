...
import fdt.recruitment.BuildConfig
import fdt.recruitment.constants.API_KEY
import fdt.recruitment.constants.BASE_URL
...
open class WebService @Inject constructor(context: Context) {
    ...
    private fun createOkHttpClient(): OkHttpClient {
        try {
            val builder = OkHttpClientBuilder.getOkHttpBuilder()
